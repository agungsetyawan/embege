    ...
    <>
      ...
      {branch && mode !== "tree" ? (
        ...
        >
          ...
          {/* biome-ignore lint/a11y/noStaticElementInteractions lint/a11y/useKeyWithClickEvents: registry-owned; keyboard handling lives in the listbox model, this span is a pointer-only affordance inside an option. */}
          <span
