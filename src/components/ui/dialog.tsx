...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // z-1000: must sit above Leaflet panes (z-200..1000), same as the sheet.
